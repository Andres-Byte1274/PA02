...
// Used for Tasks request and replies
...
func main() {
	...
	//Get the user entered arguments
	//Get the first command line argument and convert it to an int
	...
	//Get the second command line arg and convert it to an int
	...
	filename := os.Args[3] //Get the file name
